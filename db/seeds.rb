...
post2 = Post.create(user_id: user3.id, img:"https://picsum.photos/200/300", content:"Some nice content")
post3 = Post.create(user_id: user2.id, img:"https://picsum.photos/200/300", content:"Some bad content")
